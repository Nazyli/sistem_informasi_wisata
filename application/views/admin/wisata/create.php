      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <form action="<?php echo base_url(); ?>admin/wisata/save" method="post" id="addWisata">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label for="namaWisata" class="col-sm-4 col-form-label">Nama</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="namaWisata" id="namaWisata" placeholder="Nama Tempat Wisata">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <textarea class="form-control" rows="3" placeholder="Deskripsi Wisata . . ." name="deskripsi"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="noTelp" id="noTelp" placeholder="Nomor HP / Telp">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="alamatWeb" class="col-sm-4 col-form-label">Alamat
                        Web</label>
                      <div class="col-sm-8">
                        <input type="url" class="form-control" name="alamatWeb" id="alamatWeb" placeholder="https://alamatwebsite.com">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="alamat" class="col-sm-4 col-form-label">Alamat</label>
                      <div class="col-sm-8">
                        <textarea class="form-control" rows="3" placeholder="Alamat Lengkap Wisata . . ." name="alamat"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="LatLot" class="col-sm-4 col-form-label">Latitude,
                        Longitude</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="LatLot" id="LatLot" placeholder="ex : -6.352961,106.830286">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
